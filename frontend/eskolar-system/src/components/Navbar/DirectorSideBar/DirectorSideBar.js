...
import { faUser, faChartLine, faPlus, faUsers, faNewspaper, faRightFromBracket} from '@fortawesome/free-solid-svg-icons';
      ...
      >
        ...
        <a href="https://localhost:3000/" className="flex items-center justify-center mb-5">
          ...
          <div className="bg-slate-100 text-center py-2 rounded-md mb-4 ">
            <p className="text-lg text-gray-700 font-medium">Director</p>
          </div>

          <ul className="space-y-2 font-medium mt-6">
            <li>
              <a href="/directordashboard" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
              <a href="/directorreports" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                <FontAwesomeIcon icon={faNewspaper} className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
