  ...
  export default function AdminForms() {
    ...
    const openAddFormModal = () => {
      ...
      setForms({
        ...
        form_status: 'active', // Set the default status to 'active' or any desired default
        fields: [],
      });
    };
      ...
      return (
        <div className={`modal ${isModalOpen ? 'modal-open' : 'modal-close'}`}>
          <div className="modal-content p-4 max-w-md mx-auto bg-white shadow-md rounded-md">
            <h2 className="text-2xl font-bold mb-4 text-center">Add Form</h2>
            <input
              type="text"
        ...
        <div className={`modal ${updateFormModalOpen ? 'modal-open' : 'modal-close'}`}>
          <div className="modal-content p-4 max-w-md mx-auto bg-white shadow-md rounded-md">
            ...
            <div className="button-container2 mt-4 flex justify-end">
              ...
              <button
                onClick={isEditing ? closeUpdateFormModal : closeModal}
                className="bg-red-500 text-white px-4 py-2 rounded"
              >
                Cancel
              </button>
      ...
      <>
        ...
        <div className="p-4 sm:ml-64">
          <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            ...
            {addFormModalOpen && (
              <div className={`modal ${addFormModalOpen ? 'modal-open' : 'modal-close'}`}>
              <div className="modal-content p-4 max-w-md mx-auto bg-white shadow-md rounded-md">
                <h2 className="text-2xl font-bold mb-4 text-center">Add Form</h2>
                <input
                  type="text"
